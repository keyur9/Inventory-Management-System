...
namespace WindowsFormsApplication2
{
    public partial class updel : Form
    {
        ...
        private void radioButton2_CheckedChanged(object sender, EventArgs e)
        {
                        ...
                        txtState.Hide(); mtbContact.Hide(); mtbOffice.Hide(); txtEmail.Hide(); btnGo.Hide();                  
                        label11.Show(); btnUpdate.Hide(); btnExit.Hide(); deldel.Show(); delexit.Show();
                        label2.Hide(); label3.Hide(); label12.Hide(); label13.Hide(); label14.Hide();
                        label5.Hide(); label6.Hide(); label7.Hide(); label8.Hide(); label9.Hide();
                        label10.Hide(); label17.Hide();
        }
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM CustomerInfo WHERE ContactPerson LIKE '" + txtCntctPerson.Text + "'", con);
                SqlDataReader dr = cmd.ExecuteReader();
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        txtCmpnyName.Text = dr[1].ToString();
                        //txtCntctPerson.Text = dr[2].ToString();
            ...
            {
                MessageBox.Show("Enter ContactPerson", "", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        }

        private void update_CheckedChanged(object sender, EventArgs e)
        {
            txtCmpnyName.Show(); txtCntctPerson.Show(); txtAddress.Show(); txtCity.Show(); label11.Show();
                        txtState.Show();mtbContact.Show();mtbOffice.Show();txtEmail.Show(); btnUpdate.Show();
                        btnExit.Show(); deldel.Hide(); delexit.Hide(); btnGo.Show();
                        label2.Show(); label3.Show(); label12.Show(); label13.Show(); label14.Show();
                        label5.Show(); label6.Show(); label7.Show(); label8.Show(); label9.Show();
                        label10.Show(); label17.Show();
        }
                    ...
                    else
                    {
                        ...
                        if (strregex.IsMatch(valid))
                        {
                            try
                            {
                                ...
                                cmd = new SqlCommand("UPDATE CustomerInfo SET CompanyName='" + txtCmpnyName.Text + "',Address='" + txtAddress.Text + "',City='" + txtCity.Text + "',State='" + txtState.Text + "',ContactNo='" + mtbContact.Text + "',OfficeNo='" + mtbOffice.Text + "',EmailID='" + txtEmail.Text + "' WHERE ContactPerson='" + txtCntctPerson.Text + "'", con);
        ...
        private void deldel_Click(object sender, EventArgs e)
        {
            if (txtCntctPerson.Text!="")
            {
                try
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand();
                    cmd = new SqlCommand("DELETE From CustomerInfo WHERE ContactPerson='" + txtCntctPerson.Text + "'", con);
        ...
        private void updel_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT ContactPerson FROM CustomerInfo WHERE ContactPerson LIKE '" + txtCntctPerson.Text + "%'";
            con.Open();
